...
Admin/root/Members.php

Lists the SSIM Property Members.
...
Head('SSIM Property Members', true);

echo "<h2 class=c>SSIM Property Members</h2>
<p class=c>For a simple list of Properties without the Members see <a href=Properties.php>Properties</a>.</p>
<table class=mc>
";
...
CREATE TABLE PMembers (
  ...
  Bits    smallint unsigned not null, # Property Member bits: PMemB_... defined in ConstantsSSIM.inc
