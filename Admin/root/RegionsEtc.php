...
Lists the SSIM Regions, Countries, Currencies,StockExchanges and Languages Tables
...
*/
echo "<h1 class=c>SSIM Regions, Countries, Currencies, Stock Exchanges, Languages, and Industries</h1>
<table class='itran mc'>
<tr><td><ul class=mt0>
<li><a href=#SR>SSIM Regions and Groupings</a></li>
<li><a href=#SC>SSIM Countries</a></li>
<li><a href=#SU>SSIM Currencies</a></li>
<li><a href=#SX>SSIM Stock Excganges</a></li>
<li><a href=#SL>SSIM Languages</a></li>
<li><a href=#SI>SSIM Industries</a></li>
</ul></td></tr>
</table>
<a name=SR></a>
<h2 class=c>SSIM Regions and Groupings</h2>
<table class=mc>
...
echo "</table>
<a name=SC></a>
<div class=topB onclick=window.scrollTo(0,0)>Top</div><br>
";
...
echo '<h2 class=c>SSIM Countries</h2>
<table class=mc>
';
...
$res->free();
echo '</table>
<h2 class=c>SSIM Cryptocurrencies to be added</h2>
<a name=SX></a>
<div class=topB onclick=window.scrollTo(0,0)>Top</div><br>
<h2 class=c>SSIM Stock Exchanges (To be updated as needed)</h2>
<table class=mc>
';
...
<a name=SL></a>
<div class=topB onclick=window.scrollTo(0,0)>Top</div><br>
<h2 class=c>SSIM Languages (To be updated as needed)</h2>
<table class=mc>
';
...
<a name=SI></a>
<div class=topB onclick=window.scrollTo(0,0)>Top</div><br>
<h2 class=c>SSIM Industries (SIC Codes)</h2>
<table class=mc>
';
