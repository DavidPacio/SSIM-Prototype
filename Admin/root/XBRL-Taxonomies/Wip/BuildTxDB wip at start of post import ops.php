...
# 2018.10.21 Taken OoS
# $RefsA = [ # Possible Reference subnotes
#   'Name' => 0,              # ref:Name
#   'Number' => 0,            # ref:Number
...
#   'URI' => 0,               # ref:URI
#   'URIDate' => 0,           # ref:URIDate
#   'IssueDate' => 0,         # ref:IssueDate
#   'Clause' => 0,            # ref:Clause
...
function Schema($loc) {
  ...
  if ($SchemaId > 0) {
    ...
    $StackDepth++;
    echo "Schema $SchemaId Node $NodeX stacked, depth $StackDepth<br>";
...
function InsertOrUpdate($table, $key, $kv, $set) {
  ...
  if ($o = $DB->OptObjQuery("Select Id,FileIds From $table where $key='$kv'")) {
    ...
    Insert($table, $set . ",FileIds=$FileId");
