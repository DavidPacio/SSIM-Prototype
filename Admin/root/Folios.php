...
History:
2018.10.09 Started based on SIM version which was based on the UK-GAAP-DPL HypercubesList.php

*/
require '../inc/BaseSSIM.inc';
require '../structs/Folios.inc';     # $FolioPropsA used by IsFolioSubset()
require '../structs/PMemNamesA.inc'; # $PMemNamesA

Head('SSIM Folios', true);
