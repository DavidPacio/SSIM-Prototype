<?php /* Admin/root/BuildSsimStructs.php

Build the SSIM Structs

History:
2018.10.08 Started based on the SIM version
...
Head('Build SSIM Structs');

echo "<h2 class=c>Build the SSIM Structs</h2>
";
...
file_put_contents('../structs/Folios.inc', '<?php
'. $FolioPropsS
 . $FolioNamesS);
...
file_put_contents('../structs/PropNamesA.inc', '<?php
'. $PropNamesAS);
file_put_contents('../structs/PMemNamesA.inc', '<?php
'. $PMemNamesAS);
file_put_contents('../structs/PMemLabelsA.inc', '<?php
'. $PMemLabelsAS);
file_put_contents('../structs/PMemsA.inc', '<?php
' . $PMemsAS);
file_put_contents('../structs/PMemMapA.inc', '<?php
' . $PMemMapAS);
file_put_contents('../structs/PMemSumTreesA.inc', '<?php
' . $PMemSumTreesAS);
file_put_contents('../structs/PMemTargetsA.inc', '<?php
' . $PMemTargetsAS
...
file_put_contents('../structs/Zones.inc', '<?php
' . $ZonesAS
  . $ZoneRefsAS);
