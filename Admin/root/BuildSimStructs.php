...
file_put_contents('../str/Folios.inc', '<?php
'. $FolioPropsS
 . $FolioNamesS);
...
file_put_contents('../str/PropNamesA.inc', '<?php
'. $PropNamesAS);
file_put_contents('../str/PMemNamesA.inc', '<?php
'. $PMemNamesAS);
file_put_contents('../str/PMemLabelsA.inc', '<?php
'. $PMemLabelsAS);
file_put_contents('../str/PMemsA.inc', '<?php
' . $PMemsAS);
file_put_contents('../str/PMemMapA.inc', '<?php
' . $PMemMapAS);
file_put_contents('../str/PMemSumTreesA.inc', '<?php
' . $PMemSumTreesAS);
file_put_contents('../str/PMemTargetsA.inc', '<?php
' . $PMemTargetsAS
...
file_put_contents('../str/Zones.inc', '<?php
' . $ZonesAS
  . $ZoneRefsAS);
